...
public class IPv4Test
{
    ...
    public void Address_SummaryRange_Test1()
    {
        ...
        string[] expected = [
            "4.21.11.19/32", "4.21.11.20/30", "4.21.11.24/29", "4.21.11.32/27",
            "4.21.11.64/26", "4.21.11.128/25", "4.21.12.0/22", "4.21.16.0/20",
            "4.21.32.0/19", "4.21.64.0/18", "4.21.128.0/17", "4.22.0.0/15",
            "4.24.0.0/13", "4.32.0.0/11", "4.64.0.0/10", "4.128.0.0/9",
            "5.0.0.0/8", "6.0.0.0/7", "8.0.0.0/7", "10.0.0.0/21",
            "10.0.8.0/23", "10.0.10.0/24", "10.0.11.0/32"
        ];

        string[] output = [
            .. from.SummarizeAddressRangeWith(to).Select(x => x.ToString())
        ];
    ...
    public void Address_SummaryRange_Test2()
    {
        ...
        string[] expected = [
            "192.168.0.0/13", "192.176.0.0/12", "192.192.0.0/10", "193.0.0.0/8",
            "194.0.0.0/7", "196.0.0.0/6", "200.0.0.0/5", "208.0.0.0/4",
            "224.0.0.0/4", "240.0.0.0/5", "248.0.0.0/6", "252.0.0.0/7",
            "254.0.0.0/8", "255.0.0.0/9", "255.128.0.0/10", "255.192.0.0/11",
            "255.224.0.0/12", "255.240.0.0/13", "255.248.0.0/14", "255.252.0.0/15",
            "255.254.0.0/17", "255.254.128.0/18", "255.254.192.0/19", "255.254.224.0/31"
        ];
